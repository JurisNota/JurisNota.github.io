...
<body class="bg-gray-100 flex flex-col items-center justify-center min-h-screen">
    ...
    <!-- Info Pop-up -->
    <div id="info-popup" class="bg-white rounded-2xl shadow-2xl p-6 md:p-8 max-w-sm w-full text-center">
        <h2 class="text-2xl font-bold text-gray-800 mb-4">Bienvenue sur JurisNota</h2>
        <p class="text-sm text-gray-600 mb-4">
            Ce site est anonyme. Nous ne collectons aucune donnée sur vous, à l'exception des notes et des commentaires que vous postez. Vos droits RGPD sont respectés, et vous pouvez à tout moment demander la suppression de votre contenu. En utilisant ce site, vous vous engagez à rester bienveillant. Tout commentaire insultant sera supprimé. Votre témoignage se doit d'être fidèle à la réalité. Votre adresse mail est demandée afin de pouvoir vous répondre efficacement. Elle sera supprimée dès qu'une réponse vous sera envoyée.
        </p>
        <button id="close-popup-btn" class="bg-green-500 text-white font-semibold py-2 px-6 rounded-full hover:bg-green-600 transition-colors duration-300 shadow-lg">
            J'ai compris !
        </button>
    </div>

    <!-- Main Content -->
    <div id="main-content" class="hidden flex flex-col items-center justify-center min-h-screen w-full">
